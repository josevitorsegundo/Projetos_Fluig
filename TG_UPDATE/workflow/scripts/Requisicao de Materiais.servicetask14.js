...
function unavailableItemsFunction(unavailableProducts){
	...
	try {
		...
		log.info('==> JVL DevDebug Result: '+result + " NUMERO MOVIMENTO: "+numMov);
...
function getWebService(Usuario, Senha){
	...
	console.info("===> JVL Devdebug info getWebService: "+authService);
	return authService;
  }
function getWebServiceProcess(Usuario, Senha){
	...
	console.info("===> JVL Devdebug info getWebServiceProcess: "+authService);
	return authService;
}