function servicetask16(attempt, message) {
	...
	log.info("TASK GERA RM=>"+availableProducts)
...
function availableItemsFunction(availableProducts){
	...
	var localProduto =hAPI.getCardValue("localProduto").split(" - ")[0]
	...
	XMLData += "<CODLOC>"+localProduto+"</CODLOC>"
	...
	for(var i = 0; i<products.length;i++){
		...
		quantidade>=saldo? quantidade=saldo.toString():false
